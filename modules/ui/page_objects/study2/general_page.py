...
class GeneralPage(BasePage):
    ...
    def find_calculator(self, searched_value):
        ...
        LOG.info("Search google cloud calculator.")
    ...
    def click_on_search_result(self):
        ...
        LOG.info("Select needed search result.")
    ...
    def enter_both_iframes(self, ext_iframe, int_iframe):
        ...
        LOG.info("Enter into external  calc iframe.")
        self.switch_to_frame(int_iframe)
        LOG.info("Enter into inner calc iframe.")
    ...
    def click_on_compute_engine_btn(self):
        ...
        LOG.info("Click on the Compute Engine btn.")
    ...
    def set_instances_value(self, value):
        ...
        LOG.info("Enter instances value.")
    ...
    def set_os_software(self, os_software):
        ...
        LOG.info("Select Operating System/Software.")
    ...
    def add_gpus_config(self, gpus_type, num_gpus):
        ...
        LOG.info("Turn on GPUs checkbox.")
    ...
    def datacenter_config(self, location):
        ...
        LOG.info("Select Datacenter location.")
    ...
    def com_usage_config(self, com_usage):
        ...
        LOG.info("Select Committed usage.")
    ...
    def estimate_btn_click(self):
        ...
        LOG.info("Click on Estimate btn.")
    ...
    def email_estimate_btn_click(self):
        ...
        LOG.info("Click on Email estimate.")
    ...
    def set_email_field(self, email):
        ...
        LOG.info("Set Email field value.")
    ...
    def send_email_btn_click(self):
        ...
        LOG.info("Click on Send Email btn.")
    ...
    def send_email(self, email):
        ...
        LOG.info("Email successfuly send.")


    # CALC ASSERTIONS METHODS ---------------------------------------------------------------------------------------------
    def get_page_title(self):
        title = self.driver.title
        LOG.warning("Get page title for assertion.")
    ...
    def get_estimate_sum(self):
        ...
        LOG.warning("Get sum for assertion.")
    ...
    def get_estimate_instances(self):
        ...
        LOG.warning("Get instances for assertion.")
    ...
    def get_estimate_os_software(self):
        ...
        LOG.warning("Get os/software for assertion.")
    ...
    def get_estimate_instance_type(self):
        ...
        LOG.warning("Get instances type for assertion.")
    ...
    def get_estimate_ssd(self):
        ...
        LOG.warning("Get SSD for assertion.")
    ...
    def get_estimate_region(self):
        ...
        LOG.warning("Get region for assertion.")
    ...
    def get_estimate_term(self):
        ...
        LOG.warning("Get term for assertion.")
    ...
    def get_estimate_hours(self):
        ...
        LOG.warning("Get hours for assertion.")
    ...
    def get_estimate_prov_model(self):
        ...
        LOG.warning("Get provision model for assertion.")
    ...
    def get_estimate_binding_sums(self):
        ...
        LOG.warning("Get binding sums for assertion.")
    ...
    def get_estimate_total(self):
        ...
        LOG.warning("Get estimate total for assertion.")
    ...
    def letter_click(self):
        ...
        LOG.info("Click on letter.")


    def open_letter(self):
        self.letter_click()
        LOG.info("Letter is opened.")
    ...
    def enter_letter_iframe(self, iframe):
        ...
        LOG.info("Enter into letter iframe.")
    ...
    def spam_close(self):
        ...
        LOG.info("Enter into external mail iframe.")
        self.switch_to_frame(self.SPAM_NEXT_IFRAME)
        LOG.info("Enter into inner mail iframe.")
        self.spam_box_close().click()
        self.get_out_of_frames()
        LOG.info("Spam closed.")
